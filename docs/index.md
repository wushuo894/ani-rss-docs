...
<picture>
  <source srcset="./image/screenshot/screenshot.avif" type="image/avif">
  <img src="./image/screenshot/screenshot.webp" loading="lazy"  alt="screenshot" class="light-only">
</picture>
<picture>
  <source srcset="./image/screenshot/screenshot-dark.avif" type="image/avif">
  <img src="./image/screenshot/screenshot-dark.webp" loading="lazy"  alt="screenshot" class="dark-only">
</picture>
